document.addEventListener('DOMContentLoaded', () =>{
    const control = document.querySelectorAll('.orders-accordion__control');
    
    control.forEach(el =>{
        el.addEventListener('click', (e) =>{
            const control = e.currentTarget;
            const content = control.nextElementSibling;
            const icon = control.querySelector('.orders-accordion__icon');
            const childContent = content.querySelectorAll('.orders-accordion__content');
    ...
    window.addEventListener('resize', (e) =>{
        const content = document.querySelectorAll('.orders-accordion__content');
        maxScrollHeight = 0;
        ...
        content.forEach(el => {
            if(el.classList.contains('open')){
                ...
                const childContent = el.querySelectorAll('.orders-accordion__content');
